...
export const App = () => {
  ...
  useTimeout(
    () => {
      if (steps === 'step-confirm3') {
        window.gtag('event', '7364_sms_pds_step3', { var: 'var6' });
        sendDataToGA({
          sum: pdsSum,
          product_type: 'ПДС',
        });
      ...
      if (steps === 'step5') {
        window.gtag('event', '7364_sms_deposit_step6', { var: 'var6' });
        submit();
      }
      setOtpCode('');
    },
  ...
  const goToStep2 = () => {
    window.gtag('event', '7364_open_pds_step1', { var: 'var6' });
  ...
  const goToStep4 = () => {
    window.gtag('event', '7364_click_open_deposit_step5', { var: 'var6' });
  ...
  const goToConfirmStep3 = () => {
    window.gtag('event', '7364_pay_pds_step2', { var: 'var6' });
      ...
      <>
        ...
        <div className={appSt.bottomBtn()}>
          <Button
            ...
            view="primary"
            onClick={() => {
              window.gtag('event', '7364_click_pay_deposit_step5_1', { var: 'var6' });
              setSteps('step5');
            }}
          >
            Оплатить
      ...
      <div style={{ backgroundColor: '#494949', minHeight: '100dvh' }}>
        ...
        <div className={appSt.bottomBtn({ confirmed: true })}>
          <Button
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', '7364_open_deposit_after_pds_step4', { var: 'var6' });
              setSteps('step3');
            }}
